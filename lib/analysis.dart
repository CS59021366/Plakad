...
void main() => runApp(new analysishead());
...
class analysishead extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: home_analysishead(),
    );
  }
}

class home_analysishead extends StatefulWidget {
  @override
  _MyAppState createState() => new _MyAppState();
}

class _MyAppState extends State<home_analysishead> {
  File _image;
  List _recognitions;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('วิเคราะห์ส่วนหัว'),
      ),
      body: Stack(
